...
## v34 Design Studio repair
- Rebuilt from the supplied v31 baseline.
- Replaced only the Design Studio UI/runtime with the Canva-inspired named-format workflow.
- Fixed the v33 startup regression where the legacy poster renderer ran after its DOM was removed.
- Fixed Design Studio format initialization ordering.
- Invoice/quote functionality and approved invoice/quote templates were not changed.
