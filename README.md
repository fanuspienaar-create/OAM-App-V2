...
## v32 specific change
- Rebuilt Design Studio as a Canva-inspired design workflow while keeping the existing OAM app shell intact.
- Replaced aspect-ratio labels such as 4:5, 9:16, 16:9 and 1:1 with named design formats such as A4, A3, A2, Facebook Ad, Instagram Post, Instagram Story, TikTok Video, YouTube Thumbnail, WhatsApp Status, Poster, Flyer, Business Card, Album Cover and Event Banner.
- Added a Design Studio home with search, Continue designing, Choose how to start, Frequently used, Popular on OAM and Quick tools.
- Added a Canva-style editor structure with Templates, Elements, Text, Uploads, Photos, Background and Brand panels, a central canvas, mobile toolbar and named format controls.
- Added local saved-design history and custom-size creation.
- Invoice, quote and existing business/branding sections were not intentionally changed.
